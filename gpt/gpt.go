...
func init() {
	...
	envVars := map[string]string{
		"OPENAI_API_KEY":  "sk-Uhz**************************************GiXGPa9r",
		"OPENAI_BASE_URL": "https://cfw***********pi.win/v1",
		"OPENAI_MODEL":    "gpt-3.5-turbo",
	}
	//envVars := map[string]string{
	//	"OPENAI_API_KEY":  "sk-ql6RVY***************************R2Ek",
	//	"OPENAI_BASE_URL": "https://gp****************/v1",
	//	"OPENAI_MODEL":    "gpt-3.5-turbo",
	//}
	// 逐个设置环境变量
...
func NewChatGptTool() *ChatGptTool {
	...
	key := "sk-ql6RVY******************************5wPl3LWlR2Ek"
	url := "https://g***************ne/api/v1"
