...
require (
	...
	rnd-git.valsun.cn/ebike-server/go-common v0.5.7
)
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin v0.44.0 // indirect
